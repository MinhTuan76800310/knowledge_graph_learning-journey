...
\draw[ax] (-0.4,0) -- (8.7,0) node[below right,font=\tiny]{lớp cơ chế $c$};
...
\draw[arrow, red!70!black] (0.5,0.55) -- node[above,font=\tiny,text=red!70!black]{đuôi biến mất} (0.5,0.06);
\draw[arrow, red!70!black] (7.5,0.55) -- (7.5,0.06);

\node[label, align=center, text width=8.5cm] at (4,-0.95)
  {$\sigma_{t+1}^2=\sigma_t^2(1-1/M)$: phương sai co, đuôi hiếm tuyệt chủng.};
...
\begin{scope}[shift={(10.4,0)}]
  ...
  \node[font=\tiny, text=blue!60!black, align=center] at (1.7,-0.6) {Entropy tri thức\\giảm đơn điệu};
\end{scope}

\node[label, align=center, text width=15cm] at (6.5,-1.9)
  {Sụp đổ tự thực: khớp lại trên đầu ra tổng hợp làm phân bố co về vài lớp đầu ngành.};
\end{tikzpicture}
\end{document}

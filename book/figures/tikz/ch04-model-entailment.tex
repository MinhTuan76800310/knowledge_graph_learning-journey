...
\node[font=\small\bfseries,anchor=north] at (3.5,3.6)
  {Mô hình và Suy diễn: $O \models \alpha$};

% All interpretations universe
\node[ellipse,draw=black!30,minimum width=7.5cm,minimum height=5cm,
      fill=black!2,label={[font=\scriptsize,gray]north:Tất cả diễn giải có thể}] (universe) at (3.5,1.5) {};
...
\node[labelstyle,text=green!50!black] at (2.5,2.7) {mô hình\\(thỏa mãn $O$)};
\node[labelstyle,text=red!50!black] at (6.2,1.2) {không phải\\mô hình};

% α annotation
\node[font=\scriptsize,align=center,text=blue!80!black] at (3.3,1.3)
  {$\alpha$ đúng trong\\mọi mô hình};

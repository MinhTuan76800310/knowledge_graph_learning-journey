...
\node[lbl, below=0.3cm of valid] {Khi n\`ao đ\'ung\\trong thế giới?};
\node[lbl, below=0.3cm of assertion] {Khi n\`ao hệ thống\\biết điều n\`ay?};
\node[lbl, below=0.3cm of observation] {Khi n\`ao dữ liệu\\được đo?};
\node[lbl, below=0.3cm of system] {Khi n\`ao bản ghi\\được lưu?};

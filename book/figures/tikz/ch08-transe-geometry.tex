...
\draw[->, gray!40, thick] (-1.2, -1.2) -- (8.6, -1.2) node[below, font=\scriptsize\color{gray!60!black}] {chiều 1};
\draw[->, gray!40, thick] (-1.2, -1.2) -- (-1.2, 5.6) node[left, font=\scriptsize\color{gray!60!black}] {chiều 2};
...
\node[ent, fill=red!8, draw=red!50] (neg) at (3.2, 4.6) {Velocity$'$\\[-1pt]\scriptsize (mẫu âm)};
\draw[arrow, dashed, red!60!black] (t) -- node[label, right, pos=0.5] {đẩy ra xa} (neg);

% === Equation note ===
\node[draw, rounded corners, fill=yellow!12, align=center, font=\footnotesize] at (7.5, 4.9)
  {f(h,r,t) = −$\|$h + r − t$\|$\\[1pt] \textcolor{gray!50!black}{\itshape hình học, không phải ngữ nghĩa}};

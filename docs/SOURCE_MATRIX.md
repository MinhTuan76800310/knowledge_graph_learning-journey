...
| Forward chaining & Datalog engines (Ch5 enrichment) | Hogan et al. Ch.5 Rules and Reasoning; Abiteboul, Hull & Vianu, *Foundations of Databases* (1995) | Soufflé (Jordan et al., CAV 2016), Datalog survey (Green et al. 2013), Forgy RETE (1982), Motik et al. RDFox (AAAI 2014), OWL-RL | ACADEMIC / RESEARCH_PAPER / OFFICIAL_DOCUMENTATION | Stable | Industrial fixpoint evaluation grounding the θ + fixpoint mechanism; RETE and parallel Datalog materialisation | 5 |

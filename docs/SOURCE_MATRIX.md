...
| SHACL validation | W3C SHACL (REC 2017) | pySHACL documentation | STANDARD / OFFICIAL_DOCUMENTATION | Stable | Constraint validation for RDF graphs; no 1.2 exists yet | 5 |
...
| N-ary relations & reification | W3C RDF 1.2 Concepts (CR) | Hogan et al. Ch.2 Data Graphs | STANDARD / ACADEMIC | Candidate Recommendation | Triple terms solve longstanding n-ary relation modeling problem | 3, 6 |

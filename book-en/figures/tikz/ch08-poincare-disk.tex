...
\node[draw, rounded corners, fill=blue!8, align=left, font=\tiny, text width=3.6cm]
  (ann) at (-3.5, -1.0)
  {Near boundary: $\|\mathbf{u}\|\to1$ $\Rightarrow$ hyperbolic distance expands\\
   \textcolor{red!60!black}{$\mathrm{Vol}\propto\sinh^{d-1}(r)$ instead of $r^d$}};

% ====== Center annotation ======
\node[draw, rounded corners, fill=orange!8, align=left, font=\tiny, text width=3.2cm]
  at (3.8, 2.2)
  {Center: $\|\mathbf{u}\|\approx0$\\ abstract mechanisms};

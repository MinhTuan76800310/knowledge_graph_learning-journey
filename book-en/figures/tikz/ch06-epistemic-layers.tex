...
\node[layer, fill=red!8] (gov) {Governance Layer};
\node[layer, fill=orange!8, below=0.5cm of gov] (epi) {Epistemic Layer};
\node[layer, fill=blue!8, below=0.5cm of epi] (data) {Data Graph Layer};
...
\draw[arrow] (data.north) -- node[left, font=\scriptsize] {add context} (epi.south);
\draw[arrow] (epi.north) -- node[left, font=\scriptsize] {govern} (gov.south);
...
\node[font=\scriptsize\itshape, text=gray!60!black, left=1.2cm of epi] {feedback};

...
\node[font=\scriptsize,text=green!60!black] at (-2.8,0.0)
  {$x \in (\exists R.C)^I$ ✓};
\node[note] at (-2.8,-0.6)
  {There exists $y_1 \in C^I$ with\\$(x,y_1) \in R^I$};
...
\node[font=\scriptsize,text=green!60!black] at (2.3,0.9) {✓ all $\in C^I$};
...
\node[font=\scriptsize,text=green!60!black] at (2.3,-0.5)
  {$z \in (\forall R.C)^I$ (vacuous)};

% Bottom warning
\node[font=\scriptsize,text=red!70!black,align=center,text width=7cm]
  at (0,-1.3)
  {\textbf{Distinction:} Absence in RDF data $\neq$ absence in an interpretation.\\
   Under OWA, a missing $R$ triple for $z$ does NOT entail $z : \forall R.C$.};

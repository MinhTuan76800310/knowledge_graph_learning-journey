...
\node[label, align=center, text width=5.4cm] at (0, -2.7)
  {Same operation=DerivativeOperation,\\same withRespectTo=Time,\\different differentiand \& produces};

\node[font=\scriptsize\bfseries] at (0, 4.6) {Multi-hop retrieval: two applications sharing a mechanism and roles};
